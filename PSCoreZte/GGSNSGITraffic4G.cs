...
namespace PSCoreZte
{
    class GGSNSGITraffic4G
    {
        ...
        List<GGSNSGITraffic4G_Model> dataList = new List<GGSNSGITraffic4G_Model>();

        public int parseGgsnSgiTraffic4GFile()
        {
            int line_count = 0;
            ...
            foreach (string file_to_parse in FilesToParse)
            {
                ...
                using (StreamReader sr = File.OpenText(@file_to_parse))
                {
                    ...
                    while ((input = sr.ReadLine()) != null)
                    {
                        ...
                        GGSNSGITraffic4G_Model data = new GGSNSGITraffic4G_Model();
                        data.bdcl4GDataInByte = Convert.ToInt64(tokens[4]);
            ...
            foreach (var data in dataList)
            {
                ...
                queryString += "INSERT into ps_ggsn_4g_sgi_traffic ( bdcl_4g_data_in_byte_zte,node_name,vendor,result_time) values ('" + data.bdcl4GDataInByte + "','" + data.nodeName + "','" + data.vendor + "','" + data.resultTime.ToString("yyyy-MM-dd HH:mm:ss") + "');";
            }
    ...
    class GGSNSGITraffic4G_Model
    {
        public long bdcl4GDataInByte { get; set; }
        public DateTime resultTime { get; set; }
        public string vendor { get; set; }
        public string nodeName { get; set; }

        public GGSNSGITraffic4G_Model()
        {
            vendor = "zte";
        }
