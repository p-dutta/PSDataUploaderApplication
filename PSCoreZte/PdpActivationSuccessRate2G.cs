...
namespace PSCoreZte
{
    class PdpActivationSuccessRate2G
    {
        ...
        List<PdpActivationSuccessRate2G_Model> dataList = new List<PdpActivationSuccessRate2G_Model>();
    ...
    class PdpActivationSuccessRate2G_Model
    {
        ...
        public PdpActivationSuccessRate2G_Model()
        {
            vendor = "zte";
        }
