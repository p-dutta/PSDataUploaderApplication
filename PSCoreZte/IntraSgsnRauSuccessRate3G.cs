...
namespace PSCoreZte
{
    class IntraSgsnRauSuccessRate3G
    {
        ...
        List<IntraSgsnRauSuccessRate3G_Model> dataList = new List<IntraSgsnRauSuccessRate3G_Model>();

        public int parseIntraSgsnRauSucRate3GFile()
        {
            int line_count = 0;
            ...
            foreach (string file_to_parse in FilesToParse)
            {
                ...
                using (StreamReader sr = File.OpenText(@file_to_parse))
                {
                    ...
                    while ((input = sr.ReadLine()) != null)
                    {
                        ...
                        IntraSgsnRauSuccessRate3G_Model data = new IntraSgsnRauSuccessRate3G_Model();
                        data.intraSgsnRAUpdateProcedureAttemptedTimes = Convert.ToInt32(tokens[18]);
                        data.intraSgsnRAUpdateProcedureSuccessTimes = Convert.ToInt32(tokens[19]);
            ...
            foreach (var data in dataList)
            {
                ...
                queryString += "INSERT into ps_sgsn_3g_intra_sgsn_rau_success_rate ( iu_mode_intra_sgsn_rau_request_times,iu_mode_intra_sgsn_rau_success_times,node_name,vendor,result_time) values ('" + data.intraSgsnRAUpdateProcedureAttemptedTimes + "','" + data.intraSgsnRAUpdateProcedureSuccessTimes + "','" + data.nodeName + "','" + data.vendor + "','" + data.resultTime.ToString("yyyy-MM-dd HH:mm:ss") + "');";
            }
    ...
    class IntraSgsnRauSuccessRate3G_Model
    {
        ...
        public IntraSgsnRauSuccessRate3G_Model()
        {
            vendor = "zte";
        }
