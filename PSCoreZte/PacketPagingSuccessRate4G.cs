...
namespace PSCoreZte
{
    class PacketPagingSuccessRate4G
    {
        ...
        List<PacketPagingSuccessRate4G_Model> dataList = new List<PacketPagingSuccessRate4G_Model>();

        public int parsePagingSucRate4GFile()
        {
            int line_count = 0;
            ...
            foreach (string file_to_parse in FilesToParse)
            {
                ...
                using (StreamReader sr = File.OpenText(@file_to_parse))
                {
                    ...
                    while ((input = sr.ReadLine()) != null)
                    {
                        ...
                        PacketPagingSuccessRate4G_Model data = new PacketPagingSuccessRate4G_Model();
                        data.timesOfEpsPagingRequest = Convert.ToInt32(tokens[50]);
                        data.timesOfSuccessfulEpsPaging = Convert.ToInt32(tokens[51]);
            ...
            foreach (var data in dataList)
            {
                ...
                queryString += "INSERT into ps_sgsn_4g_s1_packet_paging_sr ( paging_request_times,paging_success_times,node_name,vendor,result_time) values ('" + data.timesOfEpsPagingRequest + "','" + data.timesOfSuccessfulEpsPaging + "','" + data.nodeName + "','" + data.vendor + "','" + data.resultTime.ToString("yyyy-MM-dd HH:mm:ss") + "');";
            }
    ...
    class PacketPagingSuccessRate4G_Model
    {
        public int timesOfEpsPagingRequest { get; set; }
        public int timesOfSuccessfulEpsPaging { get; set; }
        public DateTime resultTime { get; set; }
        public string vendor { get; set; }
        public string nodeName { get; set; }


        public PacketPagingSuccessRate4G_Model()
        {
            vendor = "zte";
        }
